//
//  ScanBusinessLeadViewController.swift
//  NewMleadsEnterprise
//
...
class ScanBusinessLeadViewController: UIViewController, NVActivityIndicatorViewable {
...
//        }
            ...
            displayAlert(strMessage: "Please add event first to create Lead")
            isValid = false
        }
...
//            self.selectedTakeActionDate = Utilities.dateFormatter(Date: startDate, FromString: "MM-dd-yyyy", ToString: "yyyy-MM-dd")
    ...
    func callADDLeadWebService()
    {
        ...
        var eventDetailsObj = EventDetail()
        if arrEventList.count > 0
        {
            let eventDataObj = arrEventList[0] as! [EventDetail]
            eventDetailsObj = eventDataObj[selectedIndexForEventIndex]
        }
...
//                MultipartFormData.append(self.dataAudioObj, withName: "recordSoundUrl", fileName: "demo.wav", mimeType: "audio/wav")
            ...
            }, to: WEBSERVICE_URL+ADD_LEAD_POST_URL, headers: header) { (result) in
...
//                                            self.navigationController?.popViewController(animated: true)
    ...
    func callADDLeadScanCardWebService()
    {
...
//        let timestamp = format.string(from: date)
        ...
        let parametersData = [
                ...
                "updatedTimeStamp": "0",
                "addedLeadType": "3",
                "endDt": "",  //- 06/23/2021 - (Take Action By)
                "userId": objLoginUserDetail.userId! as AnyObject, //-
                "firstName": "",
                "product": "", //- “”
                "process": "0", //- 0
...
extension ScanBusinessLeadViewController : UITextFieldDelegate{
...
extension ScanBusinessLeadViewController : UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension ScanBusinessLeadViewController : passFollowUpActionsDelegate{
...
extension ScanBusinessLeadViewController : WebServiceDelegate{
...
extension ScanBusinessLeadViewController : passLeadAddressDelegate{
...
extension ScanBusinessLeadViewController : passLeadNotesDelegate{
    func passNotes(strNotesData: String) {
        self.strNotes = strNotesData
    }
}

extension ScanBusinessLeadViewController : passLeadSalesOpportunityDelegate{
...
extension ScanBusinessLeadViewController : passLeadSurveyQuestionsDelegate {
...
extension ScanBusinessLeadViewController : passLeadVoiceMemoDelegate{
...
/*
extension ScanBusinessLeadViewController : ClientDelegate {
    ...
    func client(_ sender: Client!, didFinishDownloadData downloadedData: Data!) {
        let str = String(decoding: downloadedData, as: UTF8.self)
        print("didFinishDownloadData : \(str)")
    }
    
    func client(_ sender: Client!, didFailedWithError error: Error!) {
        print("didFailedWithError : \(error.debugDescription)")
    }
