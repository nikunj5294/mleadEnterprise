...
class AddTeamMemberViewController: UIViewController,NVActivityIndicatorViewable {
    ...
    @IBAction func btnRegisterClicked(_ sender: Any) {
        ...
        else
        {
            ...
            let param:[String : AnyObject] = ["accountCreatedBy":objLoginUserDetail.userId! as AnyObject,
                                           ...
                                           "phoneNumber":txtPhoneNo.text as AnyObject as AnyObject,
                                           "registerType":"E" as AnyObject,
                                           "termsCondition":1 as AnyObject,
                                           "userDeviceType":"iOS" as AnyObject,
                                           "reportsTo": selectedIDForTeamMember as AnyObject,
                                           "companyName":"" as AnyObject,
                                           "address":"" as AnyObject,
                                           "city":"" as AnyObject,
                                           "state":"" as AnyObject,
                                           "zipCode":"" as AnyObject,
                                           "country":"" as AnyObject,
                                           "companyWebSite":"" as AnyObject,
                                              "mobilePhone":txtPhoneNo.text as AnyObject,
                                           "securityQuesId":1 as AnyObject,
                                           "securityAnswer":"" as AnyObject,
                                           "event_organizer_type":Int(eventOrganizer)! as AnyObject,
                                           "hearFrom":"Search Engine" as AnyObject,
                                           "industryId":selectedIDForIndustry as AnyObject,
                                           "subscriptionType":"Free Trial" as AnyObject]
